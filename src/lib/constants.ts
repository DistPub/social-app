...
export const BSKY_SERVICE = 'https://network.hukoubook.com'
export const BSKY_SERVICE_DID = 'did:web:network.hukoubook.com'
...
export const VIDEO_SERVICE = 'https://api.hukoubook.com'
