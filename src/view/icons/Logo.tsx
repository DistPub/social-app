...
import {TextStyle, type TextProps} from 'react-native'
import Svg, {
  Defs,
  LinearGradient,
  Path,
...
export const Logo = React.forwardRef(function LogoImpl(props: Props, ref) {
  ...
  return makeLogo(ref, rest, [{width: size, height: size * ratio}, styles])
})

export function makeLogo(ref: React.ForwardedRef<any>, rest: Props,
  styles: TextStyle[],
  divStyles?: any) {
  const svg = (
    <Svg
  ...
  if (divStyles) {
    return <div ref={ref} style={divStyles}>{svg}</div>
  } else {
    return svg
  }
}
